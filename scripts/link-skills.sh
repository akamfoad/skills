...
# Dev helper for this repo. Links every skill into the local skill directories
# each agent harness reads:
...
# Collect the repo's skills once (skip deprecated + node_modules), link into every destination.
names=()
srcs=()
